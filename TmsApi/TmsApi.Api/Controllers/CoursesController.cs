...
public class CoursesController(ICourseService courseService,     ICachedCourseService cachedCourseService,
...
[EndpointDescription("Creates a course with a unique code. Returns 409 if the course code already exists.")]
    public async Task<IActionResult> CreateCourse(CreateCourseDto dto, CancellationToken ct)
    {
        ...
        await cachedCourseService.InvalidateCourseAsync(
    result.Code,
    ct);
...
[EndpointSummary("Get course by code using cache")]
